...
export default class CognitoUser {
	 ...
	 * @returns {void}
	 */
	resendConfirmationCode(callback, clientMetadata, analyticsMetadata) {
		const jsonReq = {
			ClientId: this.pool.getClientId(),
			Username: this.username,
			ClientMetadata: clientMetadata,
	 ...
	 * @returns {void}
	 */
	forgotPassword(callback, clientMetadata, analyticsMetadata) {
		const jsonReq = {
			ClientId: this.pool.getClientId(),
			Username: this.username,
			ClientMetadata: clientMetadata,
	 ...
	 * @returns {void}
	 */
	confirmPassword(confirmationCode, newPassword, callback, clientMetadata, analyticsMetadata) {
		const jsonReq = {
			ClientId: this.pool.getClientId(),
			Username: this.username,
			ConfirmationCode: confirmationCode,
